...
<body>
		<!-- Navegación -->
		<nav>
			<nav class="row navbar navbar-expand-lg customer sticky-top">
						...
						<div class="card-body" style="background-color: #8ABCDC;">
							<p>
								...
								<ul style="color: white;">
									...
									<li class="card-text"><a href="?c=Users&a=update" target="area">Actualizar Usuarios</a></li>
									<li class="card-text"><a href="?c=Users&a=delete" target="area">Eliminar Usuarios</a></li>
								</ul>
							</p>
							<p>
								...
								<ul>
									...
									<li class="card-text">Configurar Perfil</li>
								</ul>
							</p>					
						</div>
					</div>
